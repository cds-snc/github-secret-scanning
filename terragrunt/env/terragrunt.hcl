...
# DO NOT CHANGE ANYTHING BELOW HERE UNLESS YOU KNOW WHAT YOU ARE DOING OR YOU ENJOY EXCITEMENT AND UNEXPECTED ADVENTURES

inputs = {
  product_name                 = "github-secret-scanning"
